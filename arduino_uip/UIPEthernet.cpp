...
#include "utility/Enc424J600Network.h"
...
boolean UIPEthernetClass::network_send()
{
  ...
  uip_packet = Enc424J600Network::allocBlock(uip_len);
  ...
  return false;
sendandfree:
  Enc424J600Network::sendPacket(uip_packet);
  Enc424J600Network::freeBlock(uip_packet);
  uip_packet = NOBLOCK;
  return true;
}
