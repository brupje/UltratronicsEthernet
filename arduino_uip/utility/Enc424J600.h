...
/* registers in every bank */
#define ESTATL 		(0x1A|0xE0)
#define ESTATH		(0x1B|0xE0)
#define EIRL 		(0x1C|0xE0)
#define EIRH 		(0x1D|0xE0)
#define ECON1L 		(0x1E|0xE0)
#define ECON1H		(0x1F|0xE0)
...
#define  ETXSTAT_DEFER 0x80
#define  ETXSTAT_CRCBAD 0x10
...
#define ENC624J600_BANK3_SELECT				0xC6 // B3SELSPISettings mySetting(20000000, MSBFIRST, SPI_MODE0);
